...
def criar_cliente(clientes):
    cpf = input("Informe o CPF, Ex. 12312312312): ")
    cliente = filtrar_cliente(cpf, clientes)

    if cliente:
        print("\nCPF já Existe, Informe Outro Número!")
        return

    nome = input("Nome Completo: ")
    data_nascimento = input("Data de Nascimento, Ex.dd-mm-aaaa: ")
    endereco = input("Endereço Completo, Ex. logradouro, 123 - bairro - cidade/sigla estado: ")
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("\nCliente não Encontrado, Serviço Encerrado!")
        return
